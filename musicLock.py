...
# sounds
noteC2 = mixer.Sound('sounds\\noteC2.wav')
noteB = mixer.Sound('sounds\\noteB.wav')
noteA = mixer.Sound('sounds\\noteA.wav')
noteG = mixer.Sound('sounds\\noteG.wav')
noteF = mixer.Sound('sounds\\noteF.wav')
noteE = mixer.Sound("sounds\\noteE.wav")
noteD = mixer.Sound('sounds\\noteD.wav')
